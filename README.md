...
1. Scarica la release v1.0 da GitHub con `curl`:

   ```bash
   curl -L -o release-v1.0.zip https://github.com/alessiomodonesi/nonsense-generator/archive/refs/tags/v1.0.zip
   ```
